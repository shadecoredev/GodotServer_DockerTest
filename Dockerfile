...
RUN wget https://github.com/shadecoredev/Headless-HelloWorld-Godot-app/raw/refs/heads/main/build/helloworld_godotapp_linux_headless.sh -O /app/helloworld_godotapp_linux_headless.sh \
    && chmod +x /app/helloworld_godotapp_linux_headless.sh
